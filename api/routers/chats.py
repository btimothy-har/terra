...
@threads_router.put("/{thread_id}/delete",
...
async def get_thread_messages(
    request:Request,
    background_tasks:BackgroundTasks,
    thread_id:str) -> list[ThreadMessage]:
...
@threads_router.post("/{thread_id}/context/save",
...
@threads_router.get("/{thread_id}/context/search",
...
async def put_message_save(
    ...
    background_tasks.add_task(cache.put_thread_messages, request.app.cache, message.thread_id, [message.id])
    background_tasks.add_task(db.insert_message, request.app.database, message.session_id, message.thread_id, message)
