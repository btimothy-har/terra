...
Step 2
----------
Based on your plan in Step 1, determine the specific tasks and information that is required \
to fulfill the user's request and continue the conversation.
...
- Address the entire team as a whole. You should NOT assign individual tasks to specific Agents.
- NOT direct the Agents on how to complete their tasks.

Your Desired Output
----------
Long-form paragraphed context from Step 3, addressed to your team as if you were speaking to them.
"""
...
Step 1
----------
Refer to your original task description set by you. This is included in the conversation history.
...
Step 3
----------
Determine if you are now able to continue the conversation with the user based on the information \
provided by your agents.
...
- Your decision should be focused on whether there is sufficient information to respond to the user.
...
You have determined that the information provided is inadequate to continue the conversation with the user.

Step 2
----------
Review each of your agents' responses. Determine the areas where more information is needed.

Step 3
----------
Prepare feedback for your team based on the work information they have prepared. Your feedback should:
...
Your Desired Output
----------
Long-form paragraphed feedback from Step 3, addressed to your team as if you were speaking to them.
"""
